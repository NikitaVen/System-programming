...
int main( int argc, char* argv[ ] )
{
    ...
    /*const char* message = "B64: ";
    message += 5;
    ...
    if (*message == '=' && *(message + 1) == '=')
        return 1;
    if (*message != '=' && !not_validB64(message) && *(message + 1) == '=')
        return 2;
    if (!not_validB64(message) && !not_validB64(message + 1))
        return 3;
    return -2;*/
